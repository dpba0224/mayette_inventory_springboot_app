...
import com.dpbabrugena.MayetteInventory.dto.TransactionDTO;
...
import com.dpbabrugena.MayetteInventory.entity.Transaction;
import com.dpbabrugena.MayetteInventory.entity.User;
import com.dpbabrugena.MayetteInventory.enums.TransactionStatus;
import com.dpbabrugena.MayetteInventory.enums.TransactionType;
import com.dpbabrugena.MayetteInventory.exceptions.NameValueRequiredException;
...
import com.dpbabrugena.MayetteInventory.repository.SupplierRepository;
import com.dpbabrugena.MayetteInventory.repository.TransactionRepository;
import com.dpbabrugena.MayetteInventory.service.TransactionService;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Response restockInventory(TransactionRequest transactionRequest) {
        ...
        Product product = productRepository.findById(productId)
                .orElseThrow(()-> new NotFoundException("Product cannot be found"));

        Supplier supplier = supplierRepository.findById(supplierId)
                .orElseThrow(()-> new NotFoundException("Supplier cannot be found"));
