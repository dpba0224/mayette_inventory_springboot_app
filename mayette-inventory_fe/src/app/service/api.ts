...
// @Injectable annotation serves as a Decorator that marks a class as available to be provided and injected as a dependency.
@Injectable({

  // This means that since it is provided in the root, this service can be reused all throughout the parts of the web application
  providedIn: 'root',
})
export class Api {
